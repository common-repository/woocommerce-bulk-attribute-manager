<?php
/**
 * Plugin Name:       Bulk Attribute Manager for Woocommerce
 * Plugin URI:        https://wordpress.org/plugins/Bulk Attribute Manager for Woocommerce/
...
class Woocommerce_Bulk_Attribute_Manager {
    ...
    private function define_constant(){
        ...
        $this->define('WC_BAM_NAME','Bulk Attribute Manager for Woocommerce'); # Plugin Name
